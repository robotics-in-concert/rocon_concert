...
from .dotcode_generator import GraphDotcodeGenerator
from .conductor_graph_info import ConductorGraphInfo


class ConductorGraph2Dot():
    ...
    def __init__(self, clusters=False):
        ...
        self._pub_string = rospy.Publisher(self._graph.namespace + '/graph/dot', std_msgs.String, queue_size=2)
    ...
    def loginfo(self, msg):
        rospy.loginfo("Conductor Graph2Dot : %s" % msg)
