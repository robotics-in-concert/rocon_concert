# -*- coding: utf-8 -*-
#
# concert_schedulers documentation build configuration file, created by
...
htmlhelp_basename = 'concert_schedulersdoc'
...
latex_documents = [
  ('index', 'concert_schedulers.tex', u'concert\\_conductor Documentation',
...
man_pages = [
    ('index', 'concert_schedulers', u'concert_schedulers Documentation',
     [u'Daniel Stonier'], 1)
]
...
texinfo_documents = [
  ('index', 'concert_schedulers', u'concert_schedulers Documentation',
   u'Daniel Stonier', 'concert_schedulers', 'One line description of project.',
   'Miscellaneous'),
]
