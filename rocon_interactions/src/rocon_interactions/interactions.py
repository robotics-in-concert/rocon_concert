...
def load_msgs_from_yaml_resource(resource_name):
    ...
    interactions = []
    try:
        yaml_filename = rocon_utilities.find_resource_from_string(resource_name, extension='interactions')
...
class Interaction(object):
    ...
    def __init__(self, msg):
        ...
        if self.msg.icon == None:
            self.msg.icon = rocon_utilities.icon_resource_to_msg(self.msg.icon.resource_name)
