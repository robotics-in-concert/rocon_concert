# -*- coding: utf-8 -*-
#
# concert_conductor documentation build configuration file, created by
...
htmlhelp_basename = 'concert_conductordoc'
...
latex_documents = [
  ('index', 'concert_conductor.tex', u'concert\\_conductor Documentation',
...
man_pages = [
    ('index', 'concert_conductor', u'concert_conductor Documentation',
     [u'Daniel Stonier'], 1)
]
...
texinfo_documents = [
  ('index', 'concert_conductor', u'concert_conductor Documentation',
   u'Daniel Stonier', 'concert_conductor', 'One line description of project.',
   'Miscellaneous'),
]
