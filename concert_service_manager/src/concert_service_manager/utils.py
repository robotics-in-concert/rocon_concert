...
def setup_home_dirs(concert_name):
    '''
      Set up the location of the home directory as concert name for storing 
      the solution configuration and profiles of services
...
def setup_service_profile_home_dirs(concert_name, service_name):
    '''
      Set up the location of the home directory as concert and service name
