# -*- coding: utf-8 -*-
#
# Solution Configuration documentation build configuration file, created by
...
project = u'Concert Master'
copyright = u'2014, Daniel Stonier, Jihoon Lee'
...
htmlhelp_basename = 'SolutionConfigurationdoc'
...
latex_documents = [
  ('index', 'SolutionConfiguration.tex', u'Solution Configuration Documentation',
   u'Jihoon Lee', 'manual'),
]
...
man_pages = [
    ('index', 'solutionconfiguration', u'Solution Configuration Documentation',
     [u'Jihoon Lee'], 1)
]
...
texinfo_documents = [
  ('index', 'SolutionConfiguration', u'Solution Configuration Documentation',
   u'Jihoon Lee', 'SolutionConfiguration', 'One line description of project.',
   'Miscellaneous'),
]
